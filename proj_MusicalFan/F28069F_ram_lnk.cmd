...
PAGE 0 :
   ...
   RAMM0       : origin = 0x000050, length = 0x0003B0
	// (RAML0_L8) is shrinked here, because I need a dedicated ram space for the DMA-Controller
	// "RAML0_L7" and  "RAML8" at "PAGE 1" is spaced, that the region for InstaSPIN rests as is
   ///* alt */RAML0_L8    : origin = 0x008000, length = 0x00B800	 /* on-chip RAM block RAML0-L8. From 0x13800 to 0x14000 is reserved for InstaSPIN */
...
PAGE 1 :
   ...
   RAML8       : origin = 0x011800, length = 0x001FFF     /* on-chip RAM block L8 (used by DMA) */
...
// old:   .text            : > RAML0_L8,   PAGE = 0
   ...
   .stack           : > RAMM1,      PAGE = 1
// old:   .ebss            : > RAML0_L8,   PAGE = 0
   .ebss            : > RAML0_L7,   PAGE = 0
// old:   .econst          : > RAML0_L8,   PAGE = 0
   .econst          : > RAML0_L7,   PAGE = 0
// old:   .esysmem         : > RAML0_L8,   PAGE = 0
   .esysmem         : > RAML0_L7,   PAGE = 0
// old:   IQmath           : > RAML0_L8,   PAGE = 0
...
// old:   Cla1Prog         : > RAML0_L8,       PAGE = 0
   Cla1Prog         : > RAML0_L7,       PAGE = 0
// old:   unsecure_data    : > RAML0_L8,       PAGE = 0
   unsecure_data    : > RAML0_L7,       PAGE = 0
}
